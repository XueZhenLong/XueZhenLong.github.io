    ...
    if ($(window).width() > 768) {
        ...
        $.ajax({url: "/js/live2d/waifu-tips.js", dataType:"script", cache: true, success: function() {
            $.ajax({url: "/js/live2d/live2d.js", dataType:"script", cache: true, success: function() {
                ...
                // 其他杂项设置
                live2d_settings['homePageUrl'] = 'https://1als1k.coding-pages.com/'; // 主页地址，可选 'auto'(自动), '{URL 网址}'
                live2d_settings['aboutPageUrl'] = 'https://1als1k.coding-pages.com/'; // 关于页地址, '{URL 网址}'
